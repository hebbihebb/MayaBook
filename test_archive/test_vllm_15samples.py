...
# Output directory
OUTPUT_DIR = Path("output/vllm_settings_sweep")
...
def main():
    print("=" * 80)
    print("vLLM TTS SETTINGS SWEEP TEST")
    print("=" * 80)
    print(f"\nTest text: {TEST_TEXT}")
    print(f"Voice: {VOICE_DESC}")
    print(f"Model: {MODEL_PATH}")
    print(f"Backend: vLLM (HuggingFace 4-bit safetensor)")
    ...
    for i, params in enumerate(PARAM_SETS, 1):
        ...
        filename = f"vllm_temp{temp:.2f}_topp{top_p:.2f}.wav"
